<template>
  ...
  <p>En vigueur au 15/07/2024</p>
  
  <p>Conditions générales d'utilisation
    En vigueur au 15/07/2024
    Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique
    des modalités de mise à disposition du site et des services par ALEXISBRIET et de définir les
  ...
  <p>Toute inscription ou utilisation du site implique l'acceptation sans aucune réserve ni restriction des
    ...
    https://hubgamers.alexisbriet.fr se réserve le droit de modifier unilatéralement et à tout moment le
    contenu des présentes CGU.</p>
  
  <h2>Article 1 : Les mentions légales</h2>
  <p>L'édition du site https://hubgamers.alexisbriet.fr est assurée par la Société Auto-Entrepreneur
    ALEXISBRIET au capital de 0 euros, immatriculée au RCS de Amiens sous le numéro 908501133,
    dont le siège social est situé au CHEPY 80210
    Numéro de téléphone 0757500327
    Adresse e-mail : contact@alexisbriet.fr.
    Le Directeur de la publication est : BRIET Alexis</p>
  
  <p>L'hébergeur du site https://hubgamers.alexisbriet.fr est la société IONOS, dont le siège social est
    situé au 7 PLACE DE LA GARE 57200 SARREGUEMINES, avec le numéro de téléphone : 09 70 80
    89 11.</p>
  
  <h2>ARTICLE 2 : Accès au site</h2>
  <p>Le site https://hubgamers.alexisbriet.fr permet à l'Utilisateur un accès gratuit aux services suivants :
    Le site internet propose les services suivants :
    Création et gestion d'équipe avec invitation de joueurs
  ...
  <p>L’Utilisateur non membre n'a pas accès aux services réservés. Pour cela, il doit s’inscrire en
    ...
    pas la responsabilité de https://hubgamers.alexisbriet.fr. Dans ces cas, l’Utilisateur accepte ainsi ne
  ...
  <p>En vertu de la loi Informatique et Libertés, en date du 6 janvier 1978, l'Utilisateur dispose d'un droit
    ...
    exerce ce droit :</p>
  <ul>
    <li>- par mail à l'adresse email contact@alexisbriet.fr</li>
  ...
  <p>Les sources des informations diffusées sur le site https://hubgamers.alexisbriet.fr sont réputées
  ...
  <p>Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle.
    Malgré des mises à jour régulières, le site https://hubgamers.alexisbriet.fr ne peut être tenu
    ...
    Le site https://hubgamers.alexisbriet.fr ne peut être tenu pour responsable d’éventuels virus qui
  ...
  <p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces
    liens, il sortira du site https://hubgamers.alexisbriet.fr. Ce dernier n’a pas de contrôle sur les pages
  ...
  <p>Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de
    ...
    https://hubgamers.alexisbriet.fr. Les cookies ne contiennent pas d’information personnelle et ne
  ...
  <p>L’information contenue dans les cookies est utilisée pour améliorer le site
    https://hubgamers.alexisbriet.fr.</p>
